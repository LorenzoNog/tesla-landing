...
const Navbar = () => {
  return (
    <header
      className='py-4 px-10 flex items-center fixed top-0 w-full z-40 justify-between text-white'
    >
      ...
      <nav id="landing-header">
        <ul className="flex [&>li>a]:inline-block  [&>li>a]:px-4 [&>li>a]:py-1 font-medium">
          <li className="hover:bg-[#dcdbdb] hover:backdrop-blur-[20px] hover:text-black rounded transition-all duration-300 ease-in-out">
            <a href="">Vehicles</a>
          </li>
          <li className="hover:bg-[#dcdbdb] hover:backdrop-blur-[20px] hover:text-black rounded transition-all duration-300 ease-in-out">
            <a href="">Energy</a>
      ...
      <nav className="flex flex-grow items-center gap-3 justify-end basis-0 ">
        <div>
          <svg
            class="h-6 w-6"
            viewBox="0 0 24 24"
